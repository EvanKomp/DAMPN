...
class DAConv(nn.module):
    ...
    def __init__(
        ...
        self.system_features_used = system_features_size != None
    ...
    def forward(self, g, node_feats, edge_feats, system_feats = None):
        ...
        """
        if self.system_features_used and system_feats == None:
            raise ValueError(f'Layer {str(self)} expects system level features but None were passed')
        elif not self.system_features_used and system_feats != None:
            raise ValueError(f'Layer {str(self)} recieved system level features but None were expected')
